...
<div class="row justify-content-center mt-3">
    ...
    @endforeach
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content">{{ old('content', $review->content) }}</textarea>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="number" min="1" max="5" class="form-control @error('rating') is-invalid @enderror" id="rating" name="rating" value="{{ old('rating', $review->rating) }}">
